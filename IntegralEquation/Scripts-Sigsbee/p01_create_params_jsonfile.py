...
if __name__ == "__main__":
    ...
    # Load sigsbee files
    with np.load("InversionLS/Data/sigsbee-new-vz-2d.npz") as data:
        vp_vz_2d = data["arr_0"]
    with np.load("InversionLS/Data/sigsbee-new-2d.npz") as data:
        vp_2d = data["arr_0"]

    shutil.copy("InversionLS/Data/sigsbee-new-vz-2d.npz", os.path.join(basedir, "vp_vz_2d.npz"))
    shutil.copy("InversionLS/Data/sigsbee-new-2d.npz", os.path.join(basedir, "vp_true_2d.npz"))
